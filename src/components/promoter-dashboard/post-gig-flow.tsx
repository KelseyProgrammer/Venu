...
export function PostGigFlow({ onClose }: PostGigFlowProps) {
  ...
  const canProceedToNextStep = useMemo(() => {
    switch (currentStep) {
      case 1:
        return eventName.trim() && eventDate && eventTime && eventGenre && ticketCapacity.trim() && ticketPrice.trim()
      case 2:
  ...
  }, [currentStep, eventName, eventDate, eventTime, eventGenre, ticketCapacity, ticketPrice, bands, guarantee, bandsTotal])
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Promoter receives the remaining percentage
                </p>
              </div>
            </div>
          </Card>
            ...
            <Card className="p-6 bg-card border-border">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between border-t border-border pt-2">
                  ...
                  <span className="text-foreground font-medium">{100 - bandsTotal}%</span>
                </div>
              </div>
            </Card>
          </div>
